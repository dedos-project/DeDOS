...
START_TEST(test_find_value_index) {
...
START_TEST(test_rm_routing_table_entry) {
    struct routing_table *table = test_table();
...
START_TEST(test_add_routing_table_entry) {
    struct routing_table *table = test_table();
...
START_TEST(test_alter_routing_table_entry) {
    struct routing_table *table = test_table();
...
START_TEST(test_init_route_success) {
...
START_TEST(test_init_route_fail_duplicate) {
    ck_assert_int_eq(init_route(10, 100), 0);
    ck_assert_int_eq(init_route(10, 100), -1);
} END_TEST

START_TEST(test_get_endpoint_by_index_success) {
    struct routing_table *table = test_table();
...
START_TEST(test_get_endpoint_by_index_fail) {
    struct routing_table *table = test_table();
    struct msu_endpoint ep;
    ck_assert_int_eq(get_endpoint_by_index(table, 4, &ep), -1);
} END_TEST

START_TEST(test_get_endpoint_by_id_success) {
    struct routing_table *table = test_table();
    struct msu_endpoint ep;
...
START_TEST(test_get_endpoint_by_id_fail) {
    struct routing_table *table = test_table();
    struct msu_endpoint ep;
...
START_TEST(test_get_route_endpoint_success) {
    struct routing_table *table = test_table();
    struct msu_endpoint ep;
...
START_TEST(test_get_type_from_route_set_success) {
    struct routing_table *table = test_table();
...
START_TEST(test_get_type_from_route_set_fail) {
    struct routing_table *table = test_table();
    struct routing_table *table2 = init_routing_table(2, 9);
...
START_TEST(test_add_route_to_set_success) {
    init_route(10, 100);
    init_route(11, 110);
...
START_TEST(test_add_route_to_set_fail) {
    init_route(10, 100);
    struct route_set set = {.n_routes = 0};
    ck_assert_int_eq(add_route_to_set(&set, 11), -1);
} END_TEST

START_TEST(test_rm_route_from_set_success) {
    struct routing_table *table = test_table();
...
START_TEST(test_rm_route_from_set_fail) {
    struct routing_table *table = test_table();
    struct routing_table *table2 = init_routing_table(10, 9);
