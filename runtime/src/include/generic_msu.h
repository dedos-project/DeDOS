...
typedef struct msu_type_t{
     ...
     */
    int (*init)(msu_t *self, void *initial_state); 
     ...
     * IMP: was control_update_handler
     ...
     * @param data ???
     * @param optional_data ???
     * I DON'T THINK THIS IS EVER USED SO I REMOVED IT.
     */
...
struct generic_msu{
    ...
    /** Last MSU to receieve a message from this MSU.
     * Used in round-robin scheduling
     * TODO: This should be by type, in case an MSU enqueues to multiple types.
     */
    struct msu_endpoint *previous_recipient;
    ...
    /** Protected data field. TODO: Finish testing. Should it be here at all?*/
    msu_data_p data_p;
...
/** Initialize a new MSU with the specified type and ID. 
 * IMP: What is create_action???
 */
 ...
 * TODO: Pretty sure *buf below is not used*/
